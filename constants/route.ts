...
export const ADMIN_PRODUCTS_DETAIL_SERIES_CREATE_ROUTE = '/admin/products/[id]/create'
export const ADMIN_PRODUCT_SERIES_DETAIL_ROUTE = '/admin/products/[id]/[seriesId]'
export const ADMIN_PRODUCT_SERIES_DETAIL_EDIT_IMAGE_ROUTE = '/admin/products/[id]/[seriesId]/edit/images'
